    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-10 md:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 font-[var(--font-comfortaa)]" style={{ color: '#F9FAFB' }}>
            Proceso 100% Transparente
          </h2>
          <p className="text-base md:text-lg lg:text-xl max-w-3xl mx-auto font-[var(--font-dm-sans)] px-4" style={{ color: '#9CA3AF' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-start">
          ...
          <div className="space-y-6 md:space-y-8 order-1 lg:order-2">
            ...
            >
              <h3 className="text-2xl md:text-3xl font-bold mb-6 font-[var(--font-comfortaa)]" style={{ color: '#F9FAFB' }}>
                ¿Cómo funciona?
              </h3>
              <ul className="space-y-4 md:space-y-5">
                <li className="flex items-start gap-4 group">
                  <div 
                    className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all group-hover:scale-110"
                    style={{
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-lg md:text-xl mb-1.5 font-[var(--font-dm-sans)]" style={{ color: '#F9FAFB' }}>
                      Transmisión en vivo
                    </p>
                    <p className="text-sm md:text-base leading-relaxed font-[var(--font-dm-sans)]" style={{ color: '#9CA3AF' }}>
 ...
 La Lotería Nacional también verifica y valida el proceso.
            ...
            >
              <div className="flex items-center gap-3 md:gap-4 mb-4">
                ...
                >
                  <svg className="w-6 h-6 md:w-8 md:h-8" style={{ color: '#22C55E' }} fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                </div>
                <h4 className="text-xl md:text-2xl font-bold font-[var(--font-comfortaa)]" style={{ color: '#F9FAFB' }}>
                  Garantía de Transparencia
                </h4>
              </div>
              <p className="text-base md:text-lg leading-relaxed font-[var(--font-dm-sans)]" style={{ color: '#D1D5DB' }}>
