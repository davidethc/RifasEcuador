...
export function SorteoCard({ id, titulo, premio, precio, destacado = false, imagen }: SorteoCardProps) {
  ...
  return (
    ...
    >
      {/* Badge destacado */}
      {destacado && (
        <div className="absolute top-4 right-4 z-10 bg-gradient-to-r from-amber-400 to-orange-500 text-white px-4 py-2 rounded-full flex items-center gap-1.5 text-xs font-bold font-[var(--font-dm-sans)] shadow-lg">
