...
export function CertificationsBadge() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 lg:gap-6">
      {/* Licencia */}
      <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white dark:bg-gray-800 rounded-lg border-2 border-green-200 dark:border-green-800 shadow-sm">
      ...
      {/* Regulado por */}
      <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white dark:bg-gray-800 rounded-lg border-2 border-blue-200 dark:border-blue-800 shadow-sm">
      ...
      {/* Notario Público */}
      <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 bg-white dark:bg-gray-800 rounded-lg border-2 border-amber-200 dark:border-amber-800 shadow-sm">
