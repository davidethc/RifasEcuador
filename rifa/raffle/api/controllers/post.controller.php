...
class PostController{
	...
	static public function postData($table, $data){
		...
		/*=============================================
		Si la respuesta es un array asociativo con lastId y comment, 
		lo convertimos en un objeto para fncResponse
		=============================================*/
		if(is_array($response) && isset($response["lastId"]) && isset($response["comment"])){
			
			$response = array((object)$response);
			
		}else if(is_array($response) && !isset($response["lastId"])){
			
			/*=============================================
			Si es un error de PDO, lo manejamos como error
			=============================================*/
			...
			$return -> fncResponse(null, $errorMessage, null);
			return;
